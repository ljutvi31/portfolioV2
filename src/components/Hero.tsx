...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Décor de bulles animées en arrière-plan */}
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-1/2 left-1/3 w-72 h-72 bg-amber-300 dark:bg-amber-700 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
      </div>
      ...
      <div className="relative z-10 px-4 text-center">
        ...
        <p className="max-w-2xl mx-auto text-gray-700 dark:text-gray-300 text-lg mb-10 leading-relaxed">
          Développeur Web Après avoir exploré divers horizons, je me suis plongé dans le monde fascinant du
          développement web. En pleine reconversion professionnelle, j’ai suivi une formation intensive de 7 mois en
          partant de zéro, qui m’a révélé un univers aussi complexe que captivant...
        </p>
        ...
        <div className="flex justify-center gap-4 text-gray-600 dark:text-gray-300 mb-6">
          <a href="https://github.com/ljutvi31" target="_blank" rel="noopener noreferrer">
            <Github />
          </a>
